...
and lightweight interactivity (collapsible sections, copy-code buttons, concept↔tool cross-links,
...
makes the concept→tool learning path obvious and pleasant to follow.
